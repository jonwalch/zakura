...
use zakura_header_chain::{
    ...
    HeaderValidationState, MigratedPinRefutation, RecoveryRepair, StateVersion, SuffixWork,
...
use super::{
    ...
    HEADER_CHILD, HEADER_CONSENSUS_INVALID_TOMBSTONE, HEADER_DEFERRED, HEADER_ELIGIBILITY_ROOT,
...
fn expected_key_width(family: u8) -> usize {
    match HEADER_FAMILIES[usize::from(family)] {
        HEADER_CHILD | HEADER_AUX_DELIVERY => 64,
