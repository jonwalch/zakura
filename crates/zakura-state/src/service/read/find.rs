...
pub fn tip<C>(chain: Option<C>, db: &ZakuraDb) -> Option<(Height, block::Hash)>
where
    C: AsRef<Chain>,
{
    // # Correctness
...
/// If there is no chain, returns the tip of `db`.
pub fn tip_block<C>(chain: Option<C>, db: &ZakuraDb) -> Option<Arc<Block>>
where
    C: AsRef<Chain>,
{
    // # Correctness
...
/// If there is no chain, returns the tip of `db`.
pub fn tip_height<C>(chain: Option<C>, db: &ZakuraDb) -> Option<Height>
where
    C: AsRef<Chain>,
{
...
/// If there is no chain, returns the tip of `db`.
#[allow(dead_code)]
pub fn tip_hash<C>(chain: Option<C>, db: &ZakuraDb) -> Option<block::Hash>
where
    C: AsRef<Chain>,
{
...
pub fn depth<C>(chain: Option<C>, db: &ZakuraDb, hash: block::Hash) -> Option<u32>
where
    C: AsRef<Chain>,
{
...
pub fn height_by_hash<C>(chain: Option<C>, db: &ZakuraDb, hash: block::Hash) -> Option<Height>
where
    C: AsRef<Chain>,
{
    // # Correctness
...
pub fn hash_by_height<C>(chain: Option<C>, db: &ZakuraDb, height: Height) -> Option<block::Hash>
where
    C: AsRef<Chain>,
{
    // # Correctness
...
pub fn chain_contains_hash<C>(chain: Option<C>, db: &ZakuraDb, hash: block::Hash) -> bool
where
    C: AsRef<Chain>,
{
    // # Correctness
...
pub fn block_locator<C>(chain: Option<C>, db: &ZakuraDb) -> Option<Vec<block::Hash>>
where
    C: AsRef<Chain>,
{
    let chain = chain.as_ref();
