...
Accepts only `sendrawtransaction`, rate-limits by client IP, and selects one
healthy Zakura backend per request. Request bodies and client IPs are never logged.
